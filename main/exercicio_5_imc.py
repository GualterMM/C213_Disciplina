...
# MÉTODO TRADICIONAL - IMC com Controlador PID
lambda_var = 5     # lambda deve ser maior que 3.2
kp = ((2 * tau + theta) / (k * (2 * lambda_var + theta))) + 0.1
ti = tau + (theta / 2) - 0.3
td = (tau * theta) / (2 * tau + theta) - 0.7
